...
const baselinePath = path.join(root, 'database/ddl/baseline/postgres/0001_doudizhu_baseline.sql');
...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'ddz_', owner: 'sdkwork-doudizhu', domain: 'game' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into doudizhu database contract\n`);
