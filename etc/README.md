# sdkwork-doudizhu Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-doudizhu` |
| `runtimeCode` | `doudizhu` |
| Config root | `/etc/sdkwork/doudizhu/` |
| Runtime TOML | `/etc/sdkwork/doudizhu/config.toml` |
| Secrets | `/etc/sdkwork/doudizhu/secrets/` |
| Override | `SDKWORK_DOUDIZHU_CONFIG_FILE` |
